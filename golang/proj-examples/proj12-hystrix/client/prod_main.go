...
import (
	...
	"proj12-hystrix/client/Weblib"
	"proj12-hystrix/client/Wrappers"
...
func main() {
	...
	// 定义rpc服务实例 - 是否这里是在定义客户端与rpc服务端的连接？
	myService := micro.NewService(
		micro.Name("prodservice.client"),
		micro.WrapClient(NewLogWrapper),            // 支持多个wrapper
		micro.WrapClient(Wrappers.NewProdsWrapper), // 意思：把客户端包起来
	)
